...
function completeCombatCycle(run,cfg,offline=false){
  ...
  if(!run.autoRepeat){stopRun(run.id,false,false,"Single clear complete");return;}run.cycle++;run.roomIndex=0;run.roomState=null;run.enemy=null;run.cycleElapsed=0;
