const CACHE="adventure-town-v1.2.0";
const CORE=["./","./index.html","./styles.css","./game.js","./manifest.webmanifest","./img/icon.svg","./img/fantasy-town-map.webp","./img/loot-chest.svg"];
